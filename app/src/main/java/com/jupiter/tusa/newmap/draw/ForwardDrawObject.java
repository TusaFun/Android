...
public class ForwardDrawObject implements DrawOpenGlProgram {
    ...
    public void draw(float[] mvpMatrix) {
        ...
        //GLES20.glDrawArrays(GLES20.GL_LINE_LOOP, 0, capacity / geometry.getCoordinatesPerVertex());
        //GLES20.glDrawElements(GLES20.GL_LINE_LOOP, geometry.getDrawOrder().length, GLES20.GL_UNSIGNED_SHORT, geometry.getDrawListBuffer());
        GLES20.glDrawElements(GLES20.GL_TRIANGLES, drawOrder.length, GLES20.GL_UNSIGNED_INT, drawListBuffer);
